...
const CATEGORIES = [
  ...
  { icon: "🔧", title: "Maintenance & Equipment", faqs: [
    { q: "How does the maintenance schedule work?", a: "Each maintenance item has a time interval (e.g. every 90 days) and optionally an engine hours interval (e.g. every 100 hours). Keeply calculates the next due date and flags maintenance as OK, Due Soon, or Overdue." },
    { q: "What happens when I mark a maintenance item complete?", a: "The last service date updates to today, the due date advances by the interval, and a service log entry is added to the linked equipment card. You can add a comment or photo." },
  ...
  { icon: "🤖", title: "First Mate AI", faqs: [
    { q: "What can First Mate do?", a: "First Mate is your AI crew member with full context of your vessel. Ask when you last serviced the engine, what parts you need, what maintenance is due before your next passage, or how to troubleshoot an issue." },
  ...
  { icon: "📓", title: "Logbook & Engine Hours", faqs: [
    ...
    { q: "How does engine hours tracking work?", a: "Enter your ending engine hours when you log a passage. Keeply updates your vessel total and maintenance with hour-based intervals update their due status automatically." },
  ...
  { icon: "💳", title: "Billing & Plans", faqs: [
    { q: "What does the free Basic plan include?", a: "Basic is free with no credit card required. You get 1 vessel, unlimited maintenance, 3 equipment cards, 3 repairs, parts catalog, engine hours tracking, and 250MB document storage." },
