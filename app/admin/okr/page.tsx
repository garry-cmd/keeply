...
const OKRS = [
  {
    ...
    krs: [
      {
        text: '5 beta testers complete structured task plan',
        cur: 0,
        target: 5,
        unit: 'testers',
        status: 'on-track',
      ...
      {
        text: 'All 3 personas validated (Active Cruiser, Liveaboard, Upgrader)',
        cur: 1,
        target: 3,
        unit: 'personas',
        status: 'on-track',
      ...
      {
        text: 'Zero critical bugs outstanding',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'at-risk',
      ...
      {
        text: 'Feedback received from all testers',
        cur: 0,
        target: 5,
        unit: 'responses',
        status: 'not-started',
  ...
  },
  {
    ...
    krs: [
      {
        text: 'Error boundary at app root — no white-screen crashes',
        cur: 1,
        target: 1,
        unit: 'complete',
        status: 'done',
      ...
      {
        text: 'PostHog capturing production errors',
        cur: 1,
        target: 1,
        unit: 'complete',
        status: 'done',
      ...
      {
        text: 'Prettier + format-on-save configured',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'Pre-commit hook (Husky + lint-staged) blocking bad commits',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'Playwright smoke tests for 5 critical user paths',
        cur: 0,
        target: 5,
        unit: 'tests',
        status: 'not-started',
  ...
  },
  {
    ...
    krs: [
      {
        text: 'keeply.boats added to all 58 YouTube video descriptions',
        cur: 0,
        target: 58,
        unit: 'videos',
        status: 'not-started',
      ...
      {
        text: 'Founder story video produced and published',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'Active in 5 Facebook sailing groups for 4 weeks pre-launch',
        cur: 0,
        target: 5,
        unit: 'groups',
        status: 'not-started',
      ...
      {
        text: '10 micro-influencer DMs sent',
        cur: 0,
        target: 10,
        unit: 'DMs',
        status: 'not-started',
      ...
      {
        text: '5 micro-influencer partnerships confirmed (free Pro access)',
        cur: 0,
        target: 5,
        unit: 'partners',
        status: 'not-started',
      ...
      {
        text: 'All @keeplyapp social handles registered',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
  ...
  },
  {
    ...
    krs: [
      {
        text: 'Service worker added — app shell loads offline',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'Full mobile UX audit complete',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'All internet-dependent flows documented',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
  ...
  },
  {
    ...
    krs: [
      {
        text: 'Capacitor configured for iOS + Android',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'Native push notifications wired (FCM + APNs)',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'Overdue + coming-due push alerts firing on device',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'Offline sync tested and passing',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
  ...
  },
  {
    ...
    krs: [
      {
        text: 'assetlinks.json deployed to keeply.boats',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'Play Store listing complete with screenshots',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
      ...
      {
        text: 'App passes review and is live',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
  ...
  },
  {
    ...
    krs: [
      ...
      {
        text: 'Apple Developer account approved',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'on-track',
      ...
      {
        text: 'App passes App Store review',
        cur: 0,
        target: 1,
        unit: 'complete',
        status: 'not-started',
  ...
  },
  {
    ...
    krs: [
      {
        text: '500+ signups in first 30 days post-launch',
        cur: 0,
        target: 500,
        unit: 'signups',
        status: 'not-started',
      ...
      {
        text: 'App Store rating ≥ 4.4 with 50+ reviews',
        cur: 0,
        target: 50,
        unit: 'reviews',
        status: 'not-started',
...
const BACKLOG = [
  {
    ...
    status: 'in-progress',
    effort: 'M',
    notes: '~90% complete. Passages, watch entries, pre-departure & arrival checklists.',
  },
  {
    name: 'First Mate',
    status: 'in-progress',
    effort: 'L',
    notes: '~90% shipped. Conversational AI assistant, bottom sheet, tier-gated queries.',
  },
  {
    name: 'Text First Mate',
    status: 'planned',
    effort: 'S',
    notes: 'Post-GoLive. Chat with full vessel context.',
  },
  {
    name: 'Engine hours',
    status: 'planned',
    effort: 'M',
    notes: 'Post-GoLive. Dual-trigger consumables: time AND hours.',
  },
  {
    name: 'Consumables tracker',
    status: 'planned',
    effort: 'S',
    notes: 'Post-GoLive. Fluids, filters, spare parts — shown on equipment cards.',
  },
  {
    name: 'Weather (NOAA)',
    status: 'planned',
    effort: 'M',
    notes: 'Post-GoLive. Pro tier. Windy co-marketing in Phase 2.',
  },
  {
    name: 'Context-aware FAB',
    status: 'done',
    effort: 'S',
    notes: 'Shipped. FAB action changes by active tab.',
  },
  {
    name: 'Departure Check',
    status: 'planned',
    effort: 'L',
    notes: 'North star feature. Requires Logbook + Weather + Consumables first.',
  },
  {
    name: 'Layup Mode',
    status: 'icebox',
    effort: 'S',
    notes:
      'Re-evaluate fall 2026. Pauses maintenance alerts during seasonal layup; repairs stay live; shows 🛌 in health score.',
  },
  {
    name: 'Quick Capture',
    status: 'icebox',
    effort: 'M',
    notes: 'Photo → AI ID → one-time or recurring. Phase 2.',
  },
  {
    name: 'Provisioning',
    status: 'icebox',
    effort: 'M',
    notes: 'Par system for provisions. Phase 2 / liveaboard persona.',
  },
  {
    name: 'Voice input',
    status: 'icebox',
    effort: 'M',
    notes: 'Depends on native mobile app existing.',
  },
  {
    name: 'Windy partnership',
    status: 'icebox',
    effort: 'S',
    notes: 'Co-marketing. Approach after scale. Requires mobile app.',
  },
  {
    name: 'AI Coins / Credits',
    status: 'icebox',
    effort: 'L',
    notes:
      'Replace per-month query limits with rollover coin balance. Revisit at 500+ users with real usage data.',
  },
  {
    name: 'Theme audit — restore light mode toggle',
    status: 'icebox',
    effort: 'L',
    notes:
      'Current state is dark-only. Full restoration requires auditing ~40% of KeeplyApp.jsx still using hardcoded colors and converting to CSS variables. Only do this if light mode is a real product requirement.',
  },
];
...
export default function OKRPage() {
    ...
    return (
      ...
      >
        ...
        <div style={{ color: MUTED, fontSize: 14, marginTop: 6 }}>
          Sign in as {ADMIN_EMAIL} to access this page.
        </div>
        <a href="/admin" style={{ marginTop: 20, color: BLUE, fontSize: 14 }}>
          ← Back to admin
        </a>
      </div>
    );
  ...
  const atRiskKRs = OKRS.flatMap((o) => o.krs).filter(
    (k) => k.status === 'at-risk' || k.status === 'blocked'
  ).length;
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ marginBottom: 8 }}>
          <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between' }}>
            <h1 style={{ fontSize: 22, fontWeight: 700, margin: 0, color: TEXT }}>
              ⚓ Keeply — 6-Month Roadmap
            </h1>
            <a href="/admin" style={{ fontSize: 13, color: BLUE, textDecoration: 'none' }}>
              ← Admin dashboard
            </a>
          </div>
          <div
          ...
          >
            ...
            <span style={{ fontSize: 13, color: TEXT }}>
              Stand up a viable product — stable app, live on both stores, offline capable, with a
              community-driven acquisition engine.
            </span>
          </div>
        ...
        <div style={{ margin: '28px 0' }}>
          ...
          <div
            style={{
              display: 'grid',
              gridTemplateColumns: `130px repeat(${TOTAL_COLS}, 1fr)`,
              marginBottom: 6,
            }}
          >
            <div />
            {MONTHS.map((m, i) => (
              <div
                ...
                style={{
                  ...
                  textAlign: 'center',
                  paddingBottom: 4,
                  borderBottom: i === 0 ? `2px solid ${BLUE}` : `1px solid ${BDR}`,
                }}
              >
                {m}
                {i === 0 ? ' ◀ now' : ''}
        ...
        <div>
          ...
          {OKRS.map((obj) => {
            ...
            const summaryStatus = anyBlocked
              ? 'blocked'
              : anyRisk
                ? 'at-risk'
                : doneCount === obj.krs.length
                  ? 'done'
                  : 'on-track';
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            gap: 12,
                            padding: '9px 14px',
                            borderBottom: i < obj.krs.length - 1 ? `1px solid ${BDR}60` : 'none',
                          }}
                        >
                          <div style={{ flex: 1 }}>
                            ...
                            <div style={{ fontSize: 11, color: MUTED, marginTop: 3 }}>
                              {kr.unit === '$'
                                ? `$${kr.cur} / $${kr.target}`
                                : `${kr.cur} / ${kr.target}${kr.unit ? ' ' + kr.unit : ''}`}{' '}
                              · {p}%
                            </div>
                          </div>
                          <span
        ...
        <div style={{ marginTop: 32 }}>
          ...
          >
            <div
              style={{
                display: 'grid',
                gridTemplateColumns: '1fr 100px 60px 220px',
                background: CARD_OPEN,
                padding: '8px 14px',
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    gridTemplateColumns: '1fr 100px 60px 220px',
                    padding: '9px 14px',
                    borderBottom: i < BACKLOG.length - 1 ? `1px solid ${BDR}60` : 'none',
                    alignItems: 'start',
                  }}
                >
        ...
        >
          Updated by Claude · April 21, 2026 · Source of truth:{' '}
          <code style={{ color: TEXT }}>ROADMAP.md</code> in the repo.
        </div>
      </div>
    </div>
  );
