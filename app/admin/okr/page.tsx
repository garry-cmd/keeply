...
const BACKLOG = [
  ...
  { name: "Unify dual Supabase clients", status: "planned", effort: "M", notes: "Apr 26: components/supabase-client.js (hardcoded URL/key, used by KeeplyApp + supa() helper) AND lib/supabase.js (env-var-based, used elsewhere) both call createClient() separately. Produces visible 'Multiple GoTrueClient instances detected' console warning. Latent token-refresh-race risk. Pick env-var pattern, migrate all imports, delete the hardcoded one. ~1-2 hours focused work." },
];
