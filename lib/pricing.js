...
export const CAPABILITIES = {
  ...
  partsCatalog:               { label: 'Parts catalog',                   free: true,  standard: true,  pro: true  },
  ...
  // Standard+ gated
  fullLogbook:                { label: 'Repair log & full logbook',       free: false, standard: true,  pro: true  },

  // Pro-only gated
  customizableChecklists:     { label: 'Customizable checklists',         free: false, standard: false, pro: true  },
 ...
 *   "1 vessel · 10 equipment cards · Unlimited repairs · First Mate 5/mo · 250 MB storage"
