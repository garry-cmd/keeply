      ...
      >
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <Avatar size={34} />
            <div>
              <div style={{ fontSize: 14, fontWeight: 700, color: D.textPrimary, lineHeight: 1.2 }}>
                First Mate
              </div>
              <div style={{ fontSize: 10, color: D.textMuted, letterSpacing: '0.2px' }}>
                AI crew member
              </div>
            </div>
          </div>
                    ...
                    return (
                      <div
                        style={{
                          ...
                          border:
                            '1px solid ' +
                            (atLimit ? 'rgba(239,68,68,0.25)' : 'rgba(245,158,11,0.25)'),
                        }}
                      >
                        <div
                          style={{
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                flexShrink: 0,
                background:
                  input.trim() && !loading && context ? D.avatarGrad : 'rgba(255,255,255,0.08)',
