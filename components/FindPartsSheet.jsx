...
function PartResult({ part }) {
  return (
    <div style={{ marginBottom: 20 }}>
      ...
      >
        <div style={{ fontSize: 15, fontWeight: 600, color: '#fff', flex: 1 }}>{part.partName}</div>
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
...
export default function FindPartsSheet({ open, onClose, vessel, equipment, task, section }) {
  ...
  const vesselDisplay = [vessel?.year, vessel?.make, vessel?.model].filter(Boolean).join(' ');
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.5)' }}>{task}</div>
        ...
        <div style={{ padding: '16px 18px' }}>
          {!searched && !loading && (
            <div style={{ textAlign: 'center', padding: '20px 0 10px' }}>
              ...
              >
                First Mate will search West Marine, Fisheries Supply, and Defender for the exact
                part for your vessel.
              </div>
              <button
          ...
          {loading && (
            ...
            >
              ...
              <div style={{ fontSize: 13, color: 'rgba(255,255,255,0.45)' }}>
                Searching for{' '}
                {equipment?.name ? `parts for your ${equipment.name}` : `parts for this task`}…
              </div>
              <div
                style={{
                  fontSize: 11,
