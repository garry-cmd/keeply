              ...
              <div key={r.id} style={{ ...s.card, opacity: completingRepair === r.id ? 0 : 1, transform: completingRepair === r.id ? "scale(0.97)" : "scale(1)", transition: "opacity 0.5s ease, transform 0.5s ease" }}>
                <div style={{ padding: "14px 20px", display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 6, flexShrink: 0 }}>
                    ...
                    <span style={{ color: "#9ca3af", fontSize: 18, cursor: "pointer" }} onClick={function(){ const next = isExpanded ? null : r.id; setExpandedRepair(next); }}>{isExpanded ? "▾" : "▸"}</span>
                  </div>
                </div>
                {isExpanded && (
                    ...
                    <div style={{ display: "flex", borderBottom: "1px solid #f3f4f6", padding: "0 16px" }}>
                      {["notes"].map(function(t){ return (
                        <button key={t} onClick={function(e){ e.stopPropagation(); setRepairTab(function(prev){ const n = Object.assign({}, prev); n[r.id] = t; return n; }); if (t === "parts" && !sugg) getSuggestionsForRepair(r); }}
                          style={{ padding: "8px 12px", border: "none", background: "none", fontSize: 11, fontWeight: 700, cursor: "pointer", borderBottom: "2px solid " + ((repairTab[r.id] || "notes") === t ? "#7c3aed" : "transparent"), color: (repairTab[r.id] || "notes") === t ? "#7c3aed" : "#9ca3af", letterSpacing: "0.3px" }}>
                                  ...
                                  <div key={r.id} style={{ borderBottom: "1px solid #f3f4f6", opacity: isCompleting ? 0.4 : 1, transition: "opacity 0.5s" }}>
                                    ...
                                    <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "8px 0" }}>
                                      ...
                                      <div style={{ display: "flex", alignItems: "center", gap: 4, flexShrink: 0 }}>
                                        ...
                                        <span style={{ color: "#9ca3af", fontSize: 16, cursor: "pointer" }} onClick={function(){ const next = isExpanded ? null : r.id; setExpandedRepair(next); }}>{isExpanded ? "▾" : "▸"}</span>
                                    ...
                                    {isExpanded && (
                                      <div style={{ background: "#fafafa", borderTop: "1px solid #f3f4f6", marginLeft: 30 }}>
                                        <div style={{ display: "flex", borderBottom: "1px solid #f3f4f6", padding: "0 8px" }}>
                                          {["notes"].map(function(t){ return (
                                            <button key={t} onClick={function(e){ e.stopPropagation(); setRepairTab(function(prev){ const n = Object.assign({}, prev); n[r.id] = t; return n; }); if (t === "parts" && !sugg) getSuggestionsForRepair(r); }}
                                              style={{ padding: "6px 10px", border: "none", background: "none", fontSize: 11, fontWeight: 700, cursor: "pointer", borderBottom: "2px solid " + ((repairTab[r.id] || "notes") === t ? "#7c3aed" : "transparent"), color: (repairTab[r.id] || "notes") === t ? "#7c3aed" : "#9ca3af" }}>
                                              {t === "parts" ? "🔩 Parts needed" : "📝 Notes"}
                                            </button>
                                          ); })}
                                        </div>
                            ...
                            <div style={{ display: "flex", borderBottom: "1px solid #f3f4f6", padding: "0 12px" }}>
                              {["notes"].map(function(tt){ return (
                                <button key={tt} onClick={function(e){ e.stopPropagation(); setRepairTab(function(prev){ const n = Object.assign({}, prev); n[r.id] = tt; return n; }); if (tt === "parts" && !sugg) getSuggestionsForRepair(r); }}
                                  style={{ padding: "8px 10px", border: "none", background: "none", fontSize: 11, fontWeight: 700, cursor: "pointer", borderBottom: "2px solid " + ((repairTab[r.id] || "notes") === tt ? "#7c3aed" : "transparent"), color: (repairTab[r.id] || "notes") === tt ? "#7c3aed" : "#9ca3af" }}>
