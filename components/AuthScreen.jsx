...
export default function AuthScreen() {
  ...
  const s = {
    ...
    card:  { background: "#fff", borderRadius: 20, padding: 36, width: "100%", maxWidth: 420, boxShadow: "0 8px 40px rgba(0,0,0,0.10)" },
  ...
  return (
    <div style={s.wrap}>
      <div style={s.card}>
        ...
        {mode !== "reset" && (
          <>
            <button onClick={handleGoogle} disabled={loading} style={{ ...s.btn, background: "#fff", border: "1px solid #e2e8f0", color: "#374151", marginBottom: 16, display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }}>
